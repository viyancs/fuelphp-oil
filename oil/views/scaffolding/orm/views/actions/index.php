...
<?php endforeach; ?>
                    <td>
                        <a href="/<?php echo $uri ?>/view/{{list.id}}" rel="tooltip" title="View" ><i class="icon-eye-open"></i></a> |
                        <a href="/<?php echo $uri ?>/edit/{{list.id}}" rel="tooltip" title="Edit"><i class="icon-edit"></i></a> |
        ...
        <p>
            <a class="btn btn-success" href="/<?php echo $uri ?>/create">Add new <?php echo \Str::ucfirst($singular_name); ?></a>
        </p>
    </div>
</div>
<div class="row-fluid">
